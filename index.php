            ...
            <div class="col-lg-6">
                <div class="hs-story-wrap" style="border-radius: 15px;">
                    ...
                    <div class="story-details">
                        <p>At 24Lash Envy, we believe beauty is an expression of your inner self. Founded with the vision to create a luxurious space where clients can relax and rejuvenate, our salon has grown into a sanctuary of creativity, passion, and care.</p>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="hs-priceing-boxv text-center enhanced-membership-card">
                    <div class="membership-header">
                        ...
                        <p class="section-details mb-4" style="color: #6b7280;">As a registered member of 24Lash Envy, you unlock access to exclusive member prices and enjoy a range of premium services. Sign up today to take advantage of these fantastic benefits!</p>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="hs-pricing-title text-center">
                    ...
                    <p class="section-details">At 24Lash Envy, we pride ourselves on delivering stunning transformations. From elegant hairstyles to flawless makeup, our talented team brings your beauty vision to life with every service.</p>
                </div>
            </div>
        </div>
